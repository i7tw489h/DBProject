...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI推荐记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI销量预测表' ROW_FORMAT = DYNAMIC;
...
-- Records of dishes
-- ----------------------------
INSERT INTO `dishes` VALUES (1, '宫保鸡丁', 18.00, '/images/dishes/1.jpg', '经典川菜，鸡肉嫩滑，花生酥脆，微辣酸甜', '鸡肉、花生、干辣椒、黄瓜、胡萝卜', 1, 1, 44, 1, 2, '2026-05-15 23:44:52', '2026-05-23 20:37:01');
INSERT INTO `dishes` VALUES (2, '鱼香肉丝', 16.00, '/images/dishes/2.jpg', '川味经典，肉丝鲜嫩，酸甜微辣', '猪肉丝、木耳、胡萝卜、青椒、笋丝', 1, 1, 34, 1, 2, '2026-05-15 23:45:14', '2026-05-23 20:36:20');
INSERT INTO `dishes` VALUES (3, '红烧肉', 22.00, '/images/dishes/3.jpg', '色泽红亮，肥而不腻，入口即化', '五花肉、生姜、大葱、八角、桂皮', 1, 1, 22, 1, 2, '2026-05-15 23:45:14', '2026-05-23 19:34:55');
INSERT INTO `dishes` VALUES (4, '糖醋里脊', 20.00, '/images/dishes/4.jpg', '外酥里嫩，酸甜可口', '猪里脊肉、淀粉、番茄酱、白糖', 1, 1, 34, 1, 0, '2026-05-15 23:45:14', '2026-05-17 16:11:24');
...
INSERT INTO `dishes` VALUES (6, '蒜蓉菠菜', 10.00, '/images/dishes/蒜蓉菠菜.jpg', '蒜香浓郁，清爽开胃', '菠菜、大蒜、香油、盐', 2, 1, 48, 1, 1, '2026-05-15 23:45:14', '2026-05-18 11:39:05');
...
INSERT INTO `dishes` VALUES (8, '番茄炒蛋', 12.00, '/images/dishes/番茄炒蛋.jpg', '酸甜可口，老少皆宜', '番茄、鸡蛋、葱花、白糖', 2, 2, 46, 1, 2, '2026-05-15 23:45:14', '2026-05-23 20:30:33');
...
INSERT INTO `dishes` VALUES (11, '白米饭', 2.00, '/images/dishes/白米饭.jpg', '粒粒分明，口感软糯', '大米', 4, 4, 199, 1, 1, '2026-05-15 23:45:14', '2026-05-18 11:26:19');
...
INSERT INTO `dishes` VALUES (13, '豆沙包', 4.00, '/images/dishes/豆沙包.jpg', '香甜软糯，豆沙细腻', '面粉、红豆沙、酵母', 5, 2, 79, 1, 0, '2026-05-15 23:45:14', '2026-05-18 12:36:01');
INSERT INTO `dishes` VALUES (14, '花卷', 3.00, '/images/dishes/花卷.jpg', '层次分明，咸香可口', '面粉、葱花、盐、酵母', 5, 2, 59, 1, 0, '2026-05-15 23:45:14', '2026-05-18 12:36:01');
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '营养成分表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of nutrition
-- ----------------------------
INSERT INTO `nutrition` VALUES (1, 1, 285.00, 22.00, 18.00, 15.00, 450.00, 2.00, '2026-05-15 23:44:52', '2026-05-16 10:38:24');
...
) ENGINE = InnoDB AUTO_INCREMENT = 52 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户忌口表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `users` VALUES (10, '2430200244', 'f25a2fc72690b780b2a14e140ef6a9e0', 'wendy', '软件学院', '15369807341', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-15 23:23:10', '2026-05-15 23:23:10');
